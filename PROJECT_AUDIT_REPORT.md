# IP-SAKTI Sahayak — Full Read-Only Project Audit Report
...
- **Out-of-Scope Test**: `"What is the capital of Mars?"` $ightarrow$ **Abstained = True** (`confidence_score` = 2.0%, **0 Gemini LLM calls**).
...
- **Test Case**: Classical Ayurvedic Hair Oil (*Bhringamalakadi Taila*) $ightarrow$ Result: **`Classical Ayurvedic Medicine`** (NOT Cosmetic).

---

## 11. ABS Compliance Engine Test

- **Test Case**: Foreign entity accessing cultivated Indian biological resource $ightarrow$ Result: **`Foreign Entity — ABS Approval Required`** (`BD Act 2002, Section 3 & NBA Regulations 2014`).
...
L. **WHETHER FRONTEND $ightarrow$ BACKEND WORKS**: **YES** (FastAPI endpoints mapped to Next.js UI).
